...
\begin{enumerate}
    ...
    \item Golriz Khatami, S., Robinson, C., Birkenbihl, C., Domingo-Fernández, D., \textbf{Hoyt, C. T.}, \& Hofmann-Apitius, M. (2019; ). Challenges of Integrative Disease Modeling using Neuroimaging Features. \textit{Frontiers in Molecular Biosciences}, \textit{in review}.
\end{enumerate}
