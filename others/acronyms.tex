...
\DeclareAcronym{CONSO}{
	short = CONSO,
	long  = Curation of Neurodegeneration Supporting Ontology
}
\DeclareAcronym{CSV}{
	short = CSV,
...
\DeclareAcronym{GOCAM}{
	short             = GO-CAM,
	short-plural-form = GO-CAMs,
	long              = Gene Ontology Causal Activity Model,
	long-plural-form  = Gene Ontology Causal Activity Models
}
...
\DeclareAcronym{KG}{
	short             = KG,
	short-plural-form = KGs,
	long  = Knowledge Graph,
	long-plural-form  = Knowledge Graphs
}
\DeclareAcronym{KGE}{
	short = KGE,
	long  = Knowledge Graph Embedding
}
\DeclareAcronym{KGEM}{
	short             = KGEM,
	short-plural-form = KGEMs,
	long              = Knowledge Graph Embedding Model,
	long-plural-form  = Knowledge Graph Embedding Models
}
\DeclareAcronym{MEDIC}{
	short = MEDIC,
	long  = merged disease vocabulary
}
\DeclareAcronym{MeSH}{
	short = MeSH,
...
\DeclareAcronym{REACH}{
	short = REACH,
	long  = Reading and Assembling Contextual and Holistic Mechanisms from Text
}
\DeclareAcronym{RGD}{
	short = RGD,
...
\DeclareAcronym{SBGN}{
	short = SBGN,
	long  = Systems Biology Graphical Notation
}
\DeclareAcronym{SBML}{
	short = SBML,
...
\DeclareAcronym{TEES}{
	short = TEES,
	long  = Turku Event Extraction System
}
